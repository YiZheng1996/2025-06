...
namespace MainUI
{
    partial class frmMainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnAboutDevice = new UISymbolButton();
            ...
            // panelmue
            // 
            panelmue.Controls.Add(btnAboutDevice);
            ...
            panelmue.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            ...
            // btnAboutDevice
            // 
            btnAboutDevice.BackColor = Color.Transparent;
            btnAboutDevice.FillColor = Color.FromArgb(65, 100, 204);
            btnAboutDevice.FillColor2 = Color.FromArgb(65, 100, 204);
            btnAboutDevice.FillDisableColor = Color.FromArgb(113, 143, 226);
            btnAboutDevice.FillHoverColor = Color.FromArgb(113, 143, 226);
            btnAboutDevice.FillPressColor = Color.FromArgb(65, 100, 204);
            btnAboutDevice.FillSelectedColor = Color.FromArgb(113, 143, 226);
            btnAboutDevice.Font = new Font("微软雅黑", 13F, FontStyle.Bold);
            btnAboutDevice.ForeColor = Color.FromArgb(235, 227, 221);
            btnAboutDevice.ForeDisableColor = Color.FromArgb(235, 227, 221);
            btnAboutDevice.Image = (Image)resources.GetObject("btnAboutDevice.Image");
            btnAboutDevice.ImageInterval = 4;
            btnAboutDevice.Location = new Point(5, 769);
            btnAboutDevice.MinimumSize = new Size(1, 1);
            btnAboutDevice.Name = "btnAboutDevice";
            btnAboutDevice.Radius = 30;
            btnAboutDevice.RectColor = Color.FromArgb(65, 100, 204);
            btnAboutDevice.RectDisableColor = Color.FromArgb(65, 100, 204);
            btnAboutDevice.RectHoverColor = Color.FromArgb(113, 143, 226);
            btnAboutDevice.RectPressColor = Color.FromArgb(65, 100, 204);
            btnAboutDevice.RectSelectedColor = Color.FromArgb(113, 143, 226);
            btnAboutDevice.Size = new Size(127, 47);
            btnAboutDevice.Symbol = 0;
            btnAboutDevice.SymbolDisableColor = Color.FromArgb(90, 95, 102);
            btnAboutDevice.SymbolSize = 25;
            btnAboutDevice.TabIndex = 126;
            btnAboutDevice.Text = "关于设备";
            btnAboutDevice.TipsFont = new Font("宋体", 11F);
            btnAboutDevice.Click += btnAboutDevice_Click;
            // 
            // btnDeviceDetection
            // 
            ...
            PanelHmi.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
