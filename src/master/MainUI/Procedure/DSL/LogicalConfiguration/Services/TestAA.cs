...
namespace MainUI.Procedure.DSL.LogicalConfiguration
{
    ...
    /// </summary>
    public sealed class TestAA : IniConfig, IPLCConfigurationService, IDisposable
    {
        private const string MODULE_FILE_PATH = "Modules\\MyModules.ini";
        private static readonly string AppPath = AppDomain.CurrentDomain.BaseDirectory;

        private readonly ILogger<TestAA> _logger;
        ...
        public TestAA(ILogger<TestAA> logger, string configPath = null) 
